...
export enum DifficultyTag {
  Difficulty1 = "__PRIVATE_1_STAR",
  Difficulty2 = "__PRIVATE_2_STAR",
  Difficulty3 = "__PRIVATE_3_STAR",
}

export const DifficultyTagLabels: { [key in DifficultyTag]: string } = {
  [DifficultyTag.Difficulty1]: "1 étoile",
  [DifficultyTag.Difficulty2]: "2 étoiles",
  [DifficultyTag.Difficulty3]: "3 étoiles",
};
