...
VectorFieldBlock = 20
	...
	export interface Block {
		Kind: BlockKind
		Data: ExpressionFieldBlock | FigureAffineLineFieldBlock | FigureBlock | FigurePointFieldBlock | FigureVectorFieldBlock | FigureVectorPairFieldBlock | FormulaBlock | FunctionGraphBlock | FunctionPointsFieldBlock | FunctionVariationGraphBlock | NumberFieldBlock | OrderedListFieldBlock | RadioFieldBlock | SignTableBlock | TableBlock | TableFieldBlock | TextBlock | TreeFieldBlock | VariationTableBlock | VariationTableFieldBlock | VectorFieldBlock
	}
...
export enum VectorPairCriterion {
	...
	export const VectorPairCriterionLabels: { [key in VectorPairCriterion]: string } = {
...
export interface ExerciceExt {
	...
	Origin: Origin,
	Questions: ExerciceQuestions,
	QuestionsSource: ({ [key: number]: QuestionOrigin } | null),
}
...
// github.com/benoitkugler/maths-online/prof/editor.Questions
	export type Questions = ({ [key: number]: Question } | null)
...
export interface SaveExerciceAndPreviewOut {
	...
	*/
	...
	protected async rawAskInscription(params: AskInscriptionIn) {
		...
		const rep:AxiosResponse<AskInscriptionOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawValidateInscription(params: {"data": string}) {
		...
		const rep:AxiosResponse<any> = await Axios.get(fullUrl, { params: { "data": params["data"] }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawLoggin(params: LogginIn) {
		...
		const rep:AxiosResponse<LogginOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherGetClassrooms() {
		...
		const rep:AxiosResponse<(ClassroomExt[] | null)> = await Axios.get(fullUrl, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessTeacherGetClassrooms(data: (ClassroomExt[] | null)): void 
	

	protected async rawTeacherCreateClassroom() {
		const fullUrl = this.baseUrl + "/prof/classrooms/api";
		const rep:AxiosResponse<any> = await Axios.put(fullUrl, null, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherUpdateClassroom(params: Classroom) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api";
		const rep:AxiosResponse<Classroom> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherGetClassroomStudents(params: {"id-classroom": number}) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api/students";
		const rep:AxiosResponse<(Student[] | null)> = await Axios.get(fullUrl, { params: { "id-classroom": String(params["id-classroom"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessTeacherGetClassroomStudents(data: (Student[] | null)): void 
	

	protected async rawTeacherAddStudent(params: {"id-classroom": number}) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api/students";
		const rep:AxiosResponse<Student> = await Axios.put(fullUrl, null, { params: { "id-classroom": String(params["id-classroom"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherUpdateStudent(params: Student) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api/students";
		const rep:AxiosResponse<any> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherDeleteStudent(params: {"id-student": number}) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api/students";
		const rep:AxiosResponse<any> = await Axios.delete(fullUrl, { params: { "id-student": String(params["id-student"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherImportStudents(params: {"id-classroom": string}, file: File) {
...
const rep:AxiosResponse<any> = await Axios.post(fullUrl, formData, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawTeacherGenerateClassroomCode(params: {"id-classroom": number}) {
		const fullUrl = this.baseUrl + "/prof/classrooms/api/students/connect";
		const rep:AxiosResponse<GenerateClassroomCodeOut> = await Axios.get(fullUrl, { params: { "id-classroom": String(params["id-classroom"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessTeacherGenerateClassroomCode(data: GenerateClassroomCodeOut): void 
	

	protected async rawGetTrivialPoursuit() {
		const fullUrl = this.baseUrl + "/prof/trivial/config";
		const rep:AxiosResponse<(TrivialConfigExt[] | null)> = await Axios.get(fullUrl, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessGetTrivialPoursuit(data: (TrivialConfigExt[] | null)): void 
	

	protected async rawCreateTrivialPoursuit() {
		const fullUrl = this.baseUrl + "/prof/trivial/config";
		const rep:AxiosResponse<TrivialConfigExt> = await Axios.put(fullUrl, null, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessCreateTrivialPoursuit(data: TrivialConfigExt): void 
	

	protected async rawUpdateTrivialPoursuit(params: TrivialConfig) {
		const fullUrl = this.baseUrl + "/prof/trivial/config";
		const rep:AxiosResponse<TrivialConfigExt> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessUpdateTrivialPoursuit(data: TrivialConfigExt): void 
	...
	protected async rawDuplicateTrivialPoursuit(params: {"id": number}) {
		...
		const rep:AxiosResponse<TrivialConfigExt> = await Axios.get(fullUrl, { params: { "id": String(params["id"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessDuplicateTrivialPoursuit(data: TrivialConfigExt): void 
	

	protected async rawCheckMissingQuestions(params: CategoriesQuestions) {
		const fullUrl = this.baseUrl + "/prof/trivial/config/check-missing-questions";
		const rep:AxiosResponse<CheckMissingQuestionsOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessCheckMissingQuestions(data: CheckMissingQuestionsOut): void 
	

	protected async rawGetTrivialRunningSessions() {
		const fullUrl = this.baseUrl + "/trivial/sessions";
		const rep:AxiosResponse<RunningSessionMetaOut> = await Axios.get(fullUrl, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessGetTrivialRunningSessions(data: RunningSessionMetaOut): void 
	

	protected async rawLaunchSessionTrivialPoursuit(params: LaunchSessionIn) {
		const fullUrl = this.baseUrl + "/trivial/sessions";
		const rep:AxiosResponse<LaunchSessionOut> = await Axios.put(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessLaunchSessionTrivialPoursuit(data: LaunchSessionOut): void 
	...
	protected async rawEditorStartSession() {
		...
		const rep:AxiosResponse<StartSessionOut> = await Axios.put(fullUrl, null, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawEditorPausePreview(params: {"sessionID": string}) {
		...
		const rep:AxiosResponse<any> = await Axios.get(fullUrl, { params: { "sessionID": params["sessionID"] }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawEditorGetTags() {
		...
		const rep:AxiosResponse<(string[] | null)> = await Axios.get(fullUrl, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawEditorSearchQuestions(params: ListQuestionsIn) {
		...
		const rep:AxiosResponse<ListQuestionsOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorSearchQuestions(data: ListQuestionsOut): void 
	...
	protected async rawEditorDuplicateQuestion(params: {"id": number}) {
		...
		const rep:AxiosResponse<Question> = await Axios.get(fullUrl, { params: { "id": String(params["id"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawEditorDuplicateQuestionWithDifficulty(params: {"id": number}) {
		const fullUrl = this.baseUrl + "/prof/editor/api/question-duplicate";
		const rep:AxiosResponse<any> = await Axios.get(fullUrl, { params: { "id": String(params["id"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorDuplicateQuestionWithDifficulty(data: any): void 
	

	protected async rawEditorCreateQuestion() {
		const fullUrl = this.baseUrl + "/prof/editor/api/question";
		const rep:AxiosResponse<Question> = await Axios.put(fullUrl, null, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawEditorUpdateGroupTags(params: UpdateGroupTagsIn) {
		...
		const rep:AxiosResponse<UpdateGroupTagsOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorUpdateGroupTags(data: UpdateGroupTagsOut): void 
	

	protected async rawQuestionUpdateVisiblity(params: QuestionUpdateVisiblityIn) {
	...
	protected async rawEditorCheckQuestionParameters(params: CheckQuestionParametersIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/question/check-params";
		const rep:AxiosResponse<CheckQuestionParametersOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorCheckQuestionParameters(data: CheckQuestionParametersOut): void 
	

	protected async rawEditorSaveQuestionAndPreview(params: SaveQuestionAndPreviewIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/question/preview";
		const rep:AxiosResponse<SaveQuestionAndPreviewOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorSaveQuestionAndPreview(data: SaveQuestionAndPreviewOut): void 
	

	protected async rawExercicesGetList() {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercices";
		const rep:AxiosResponse<(ExerciceHeader[] | null)> = await Axios.get(fullUrl, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessExercicesGetList(data: (ExerciceHeader[] | null)): void 
	

	protected async rawExerciceGetContent(params: {"id": number}) {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice";
		const rep:AxiosResponse<ExerciceExt> = await Axios.get(fullUrl, { params: { "id": String(params["id"]) }, headers : this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawExerciceCreate() {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice";
		const rep:AxiosResponse<ExerciceHeader> = await Axios.put(fullUrl, null, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawExerciceUpdate(params: ExerciceUpdateIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice";
		const rep:AxiosResponse<Exercice> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawExerciceCreateQuestion(params: ExerciceCreateQuestionIn) {
		...
		const rep:AxiosResponse<ExerciceExt> = await Axios.put(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawExerciceUpdateQuestions(params: ExerciceUpdateQuestionsIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice/questions";
		const rep:AxiosResponse<ExerciceExt> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected async rawExerciceUpdateVisiblity(params: ExerciceUpdateVisiblityIn) {
	...
	protected async rawEditorCheckExerciceParameters(params: CheckExerciceParametersIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice/check-params";
		const rep:AxiosResponse<CheckExerciceParametersOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorCheckExerciceParameters(data: CheckExerciceParametersOut): void 
	

	protected async rawEditorSaveExerciceAndPreview(params: SaveExerciceAndPreviewIn) {
		const fullUrl = this.baseUrl + "/prof/editor/api/exercice/preview";
		const rep:AxiosResponse<SaveExerciceAndPreviewOut> = await Axios.post(fullUrl, params, { headers: this.getHeaders() });
		return rep.data;
	}
	...
	protected abstract onSuccessEditorSaveExerciceAndPreview(data: SaveExerciceAndPreviewOut): void 
