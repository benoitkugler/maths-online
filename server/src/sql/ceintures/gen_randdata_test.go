...
func randDomain() Domain {
	choix := [...]Domain{CalculMental, Puissances, Fractions, Reduction, Factorisation, Developpement, IsolerVariable, Equations, Inequations, Derivation, Matrices}
