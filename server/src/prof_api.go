...
func setupProfAPI(e *echo.Echo, tvc *trivial.Controller,
	...
	gr.GET("/api/prof/editor/question-duplicate", edit.EditorDuplicateQuestiongroup)
	...
	gr.POST("/api/prof/editor/questiongroup/tags", edit.EditorUpdateTags)
	...
	// exercice editor
	gr.POST("/api/prof/editor/exercices", edit.ExercicesGetList)
