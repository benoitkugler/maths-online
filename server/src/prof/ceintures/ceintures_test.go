	...
	for _, test := range []struct {
		...
		{ // start
			ce.Advance{}, ce.PostBac, []Stage{
				{ce.CalculMentalI, ce.Blanche},
				{ce.CalculMentalII, ce.Blanche},
				{ce.Puissances, ce.Blanche},
				{ce.Fractions, ce.Blanche},
				{ce.Reduction, ce.Blanche},
				{ce.Factorisation, ce.Blanche},
				{ce.Developpement, ce.Blanche},
				{ce.IsolerVariable, ce.Blanche},
				// {ce.Equations, ce.Blanche},
				{ce.Inequations, ce.Blanche},
				{ce.Derivation, ce.Blanche},
