      ...
      child: NotificationListener<PointMovedNotification<VectorPairPointID>>(
        ...
        child: BaseRepere<VectorPairPointID>(
          ...
          [
            DraggableGridPoint(
              from1,
              metrics.logicalIntToVisual(from1),
              VectorPairPointID.from1,
              zoomFactor,
              color: Colors.orange,
            ),
            DraggableGridPoint(
              ...
              VectorPairPointID.to1,
              zoomFactor,
              color: Colors.orange,
            ),
            DraggableGridPoint(
              from2,
              metrics.logicalIntToVisual(from2),
              VectorPairPointID.from2,
              zoomFactor,
