...
import 'src_maths_expression_sets.dart';
...
Map<String, dynamic> answerToJson(Answer item) {
  ...
  } else if (item is SetAnswer) {
    return {'Kind': "SetAnswer", 'Data': setAnswerToJson(item)};
...
Block blockFromJson(dynamic json_) {
  ...
  switch (kind) {
    ...
    case "SetFieldBlock":
      return setFieldBlockFromJson(data);
    case "SignTableBlock":
...
Map<String, dynamic> blockToJson(Block item) {
  ...
  } else if (item is SetFieldBlock) {
    return {'Kind': "SetFieldBlock", 'Data': setFieldBlockToJson(item)};
...
// github.com/benoitkugler/maths-online/server/src/maths/questions/client.SetAnswer
class SetAnswer implements Answer {
  final ListNode root;

  const SetAnswer(this.root);

  @override
  String toString() {
    return "SetAnswer($root)";
  }
}

SetAnswer setAnswerFromJson(dynamic json_) {
  final json = (json_ as Map<String, dynamic>);
  return SetAnswer(listNodeFromJson(json['Root']));
}

Map<String, dynamic> setAnswerToJson(SetAnswer item) {
  return {"Root": listNodeToJson(item.root)};
}

// github.com/benoitkugler/maths-online/server/src/maths/questions/client.SetFieldBlock
class SetFieldBlock implements Block {
  final List<String> sets;
  final int iD;

  const SetFieldBlock(this.sets, this.iD);

  @override
  String toString() {
    return "SetFieldBlock($sets, $iD)";
  }
}
...
Map<String, dynamic> setFieldBlockToJson(SetFieldBlock item) {
  return {"Sets": listStringToJson(item.sets), "ID": intToJson(item.iD)};
}
